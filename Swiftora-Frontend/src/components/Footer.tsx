    ...
    <footer className="bg-gray-900 text-gray-300 border-t border-gray-800 mt-8 relative overflow-hidden">
      <div className="container mx-auto px-4 py-4 relative z-10">
        <div className="space-y-4">
          {/* Top row: brand + product + integrations */}
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-[11px] text-gray-500 max-w-xl leading-snug">
                ...
                Opposite to GNR Kalyana Mantapa, Jayanagar 4th T Block,
                Bengaluru, Karnataka, 560041. Legal email:{" "}
          ...
          {/* Second row: Resources / Company / Compliance / Information spread across width */}
